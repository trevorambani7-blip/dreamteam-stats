...
<style>
    ...
    /* Headers and text - White for contrast on black */
    ...
    /* Inputs, selectboxes, text areas - Dark with white text */
    ...
    /* Buttons - White background, Purple text, Rounded */
    .stButton > button {
        background-color: white !important;
        color: #500050 !important;
        border-radius: 50px !important;  /* Highly rounded corners */
        border: none !important;
        font-weight: 600;
        padding: 0.6rem 1.5rem;
        box-shadow: 0 4px 8px rgba(80, 0, 80, 0.3);
        transition: all 0.3s ease;
    }
    
    .stButton > button:hover {
        background-color: #f0e6f0 !important;  /* Light purple tint on hover */
        transform: translateY(-2px);
        box-shadow: 0 6px 12px rgba(80, 0, 80, 0.4);
    }
    
    /* Primary buttons (like Proceed) - Purple background, white text */
    /* If you want special buttons, add type="primary" in st.button */
    ...
    /* Expander (player action sections) - Dark card with purple border */
    ...
    .big-timer {
        ...
        color: #500050;
        margin: 2rem 0;
        text-shadow: 0 0 10px rgba(80, 0, 80, 0.5);
    }
